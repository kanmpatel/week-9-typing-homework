package carper_cost_calculator;
...
public class Main {
    public static void main(String[] args) {
        Carpet carpet = new carper_cost_calculator.Carpet(3.5);
       Floor floor = new carper_cost_calculator.Floor(2.75, 4.0);
       Calculator calculator = new carper_cost_calculator.Calculator(floor, carpet);
        System.out.println("total= " + calculator.getTotalCost());
        carpet = new carper_cost_calculator.Carpet(1.5);
        floor = new carper_cost_calculator.Floor(5.4, 4.5);
        calculator = new carper_cost_calculator.Calculator(floor, carpet);
        System.out.println("total= " + calculator.getTotalCost());
    }
}
